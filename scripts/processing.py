...
def proxys_processing(df,richesse_data,chomage_data,inondation_data):
    richesse=richesse_data.copy()
    chomage=chomage_data.copy()
    inondation=inondation_data.copy()
